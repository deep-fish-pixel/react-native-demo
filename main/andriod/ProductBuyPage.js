    ...
    render: function() {
        ...
        return (!state.id?<Page loading={true}></Page>:
            <Page ref="page" loading={true} validate={this.validate}>
                ...
                <TouchableHighlight underlayColor="rgb(200,200,200)"
                                    onPress= {()=>{}}>
                    <View style={styles.item}>
                        <View style={styles.flexBox}>
                ...
                <View style={[styles.item, styles.itemBorder]}>
                    ...
                    <View style={styles.flexBox}>
                        ...
                        <View style={styles.flexBox}>
                            <TouchableHighlight style={styles.minCopiesBox} underlayColor="rgb(200,200,200)" onPress={()=>{this.changeCopies(-1)}}><Text style={styles.minCopies}>-</Text></TouchableHighlight>
                            ...
                            <TouchableHighlight style={styles.addCopiesBox} underlayColor="rgb(200,200,200)" onPress={()=>{this.changeCopies(1)}}><Text style={styles.addCopies}>+</Text></TouchableHighlight>
                        </View>
                    </View>
                    <View style={styles.flexBox}>
